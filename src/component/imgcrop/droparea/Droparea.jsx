...
class Droparea extends React.Component {
  ...
  render(e) {
    return (
      <div
        className={`droparea ${this.state.fileEnterArea ? 'file-hover' : null} ${this.state.showCut ? 'no-border' : null}`}
      ...
      >
        ...
        <Cut limit={this.state.limit} showCut={this.state.showCut} imgUrl={this.state.imgUrl} ref={r => this.cut = r}></Cut>
      </div>
    )
  }
}
